<div align="center">
  ...
  <h3 align="center">Flutter Quiz Test App</h3>

  <p align="center">
    This is beginning of my path about being a "Flutter Developer".
...
In this project, I am trying to create a quiz app that has the following features of basic Dart language:

* Variables, Types
* If-else statements, Ternary operators
* Null-aware operators, 
* Collections, Iterables, Maps
* Functions, Methods, Lambdas
* Classes, Constructors, Inheritance and Polymorphism
* Exception Handling 
* Et cetera.

Of course this is not a complete list of features, but it is a good starting point for me to get started.
...
- [x] Learn basic Dart language
- [x] Learn basic Flutter widgets
- [x] Learn basic Flutter layout
- [ ] Improve the quiz app with more features
- [ ] Improve the quiz app with more UI
- [ ] Improve the quiz app with more animations
- [ ] Create database for the quiz app
- [ ] Make it online
- [ ] Publish the app to the Playstore
